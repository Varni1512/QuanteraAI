...
const AISolutionsSection = () => {
    return (
        <div className="w-full bg-white py-8 px-4 relative overflow-hidden">
            {/* Robot hand image - positioned to the right, slightly moved down */}
            <div className="absolute right-0 top-[10%] w-1/3 h-1/3 z-10 hidden md:flex flex-col items-center justify-start gap-6 pointer-events-auto">
                <img src="/robothand.png" alt="Robot Hand" className="w-full h-auto object-contain" />
                <button className="mt-6 px-6 py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded bg-white hover:bg-gradient-to-r from-[#1363C6] to-[#14183E] hover:text-white transition duration-300 hover:scale-105">
                    View All
                </button>
            </div>
