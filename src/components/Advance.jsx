...
const Advance = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to Communication and Storytelling',
            weeks: 'Week 1-2',
            description: [
                'Understanding the fundamentals of persuasive communication.',
                'Types of communication: Verbal, Non-verbal, and Visual.',
                'Analyzing impactful storytelling techniques.',
                'Case Study: TED Talks and Business Challenges.'
            ]
        },
        {
            id: 2,
            ...
            weeks: 'Week 3-4',
            description: [
                'Mastering non-verbal cues: Eye contact, gestures, and posture.',
                'Emotional intelligence in communication.',
                'Practical exercises: Recording and self-assessment of a persuasive speech.'
            ]
        },
        {
            id: 3,
            ...
            weeks: 'Week 5-6',
            description: [
                'Structure of a persuasive speech: Introduction, body, and conclusion.',
                'Techniques for persuasive delivery.',
                'Mock presentations and peer feedback.'
            ]
        },
        {
            id: 4,
            title: 'Brand Storytelling for Leaders',
            weeks: 'Week 7-8',
            description: [
                'Crafting a brand narrative.',
                'Integrating storytelling into leadership communication.',
                'Group project: Develop a TED-style talk on a business challenge.'
            ]
        },
        {
            id: 5,
        ...
        {
            id: 6,
            title: 'Presentation Day and Assessment',
            weeks: 'Week 11-12',
            description: [
                'Final presentation: TED-style talk.',
                'Individual assessment and feedback.',
                'Reflection and course completion.'
            ]
        },
    ];
