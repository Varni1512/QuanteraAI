    ...
    const courseModules = [
        {
            ...
            weeks: 'Week 1-2',
            description: [
                'Overview of robotics systems and components',
                'Introduction to Robot Operating System (ROS)',
                'Hands-on: Setting up ROS environment'
            ]
        },
        {
            id: 2,
            ...
            description: [
                ...
                'Hands-on: Basic robot control programs'
            ]
        },
        {
            id: 3,
            title: 'AI-Driven Control Systems',
            weeks: 'Week 5-6',
            description: [
                'Implementing AI for robotic control',
                'Introduction to reinforcement learning',
                'Hands-on: AI-based pathfinding and obstacle avoidance'
            ]
        },
        {
            id: 4,
            ...
            weeks: 'Week 7-8',
            description: [
                'Basics of OpenCV for computer vision',
                'Implementing object detection using TensorFlow',
                'Hands-on: Developing a vision-based robotic system'
            ]
        },
        {
            id: 5,
            ...
            weeks: 'Week 9-10',
            description: [
                'Developing a complete AI-driven robotic system',
                'Integration of ROS, OpenCV, and AI algorithms',
