...
const Advance13 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to Edge Computing and IoT',
            weeks: 'Week 1-2',
            description: [
                'Understanding Edge Computing and IoT fundamentals',
                'Use cases and applications in smart systems',
                'Practical: Setting up Raspberry Pi/Arduino for IoT'
            ]
        },
        {
            id: 2,
            title: 'Communication Protocols and Network Architecture',
            weeks: 'Week 3-4',
            description: [
                'MQTT, CoAP, and HTTP protocols',
                'Designing network architecture for IoT systems',
                'Practical: Implementing sensor data collection and cloud integration'
            ]
        },
        {
            id: 3,
            title: 'Edge Analytics and Data Processing',
            weeks: 'Week 5-6',
            description: [
                'Data preprocessing and edge analytics',
                'Deploying ML models at the edge',
                'Practical: Implementing predictive maintenance using sensor data'
            ]
        },
        {
            id: 4,
            title: 'Security in Edge and IoT Systems',
            weeks: 'Week 7-8',
            description: [
                'Identifying vulnerabilities in IoT networks',
                'Implementing encryption and security protocols',
                'Practical: Securing data transfer between edge devices and cloud'
            ]
        },
        {
            id: 5,
            ...
            weeks: 'Week 9-10',
            description: [
                'Integrating IoT devices with smart systems',
            ...
            <div className="pt-24 w-full px-4 lg:px-8 py-8 relative overflow-hidden">
                ...
                <div className="text-center mb-6 relative z-10 pt-10">
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-[30px] font-sansation font-bold bg-gradient-to-r from-[#1363C6] to-[#14183E] bg-clip-text text-transparent mb-4">
                        CERTIFICATION IN ADVANCED COMMUNICATION &amp; <br className="hidden sm:block" /> STORYTELLING FOR LEADERS
                    </h1>
                    <p
                ...
                <div className="mt-8 relative z-10">
                    ...
                    >
                        <p className="text-[#14183E] text-sm sm:text-lg md:text-xl lg:text-[25px] font-Roboto Slab">
                            If you are interested, please contact: 6261589913 or guptashivanshi250@gmail.com
                        </p>
                    </div>
                </div>
            </div>
