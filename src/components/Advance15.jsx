    ...
    const courseModules = [
        {
            ...
            description: [
                ...
                'Practical: Setting up Qiskit for quantum programming'
            ]
        },
        {
            id: 2,
            title: 'Quantum Algorithms and Gates',
            weeks: 'Week 3-4',
            description: [
                'Quantum gates and circuits',
                "Quantum algorithms: Grover's and Shor's algorithm",
                'Practical: Implementing simple quantum algorithms in Qiskit'
            ]
        },
        {
            id: 3,
            title: 'Quantum Programming and SDKs',
            weeks: 'Week 5-6',
            description: [
                'Qiskit and other quantum programming tools',
                'Quantum SDK integration and simulation',
                'Practical: Developing quantum circuits for data analysis'
            ]
        },
        {
            id: 4,
            ...
            description: [
                ...
                'Practical: Implementing QKD protocol using Qiskit'
            ]
        },
        {
            id: 5,
            title: 'Quantum Applications in AI',
            weeks: 'Week 9-10',
            description: [
                'Quantum machine learning concepts',
                'Practical: Implementing quantum support vector machines'
            ]
        },
        {
            id: 6,
            ...
            weeks: 'Week 11-12',
            description: [
                'Complete a quantum computing project',
