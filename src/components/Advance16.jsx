...
const Advance16 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to Cybersecurity and AI',
            weeks: 'Week 1-2',
            description: [
                'Fundamentals of cybersecurity',
                'Role of AI in security systems',
                'Practical: Implementing basic security protocols'
            ]
        },
        {
            id: 2,
            title: 'Threat Analysis and Penetration Testing',
            weeks: 'Week 3-4',
            description: [
                'Understanding vulnerabilities and threat analysis',
                'Ethical hacking techniques',
                'Practical: Pen testing using AI tools'
            ]
        },
        {
            id: 3,
            title: 'AI Models for Intrusion Detection',
            weeks: 'Week 5-6',
            description: [
                'Building ML models for anomaly detection',
                'Implementing AI-based IDS',
                'Practical: Developing a basic IDS using Python'
            ]
        },
        {
            id: 4,
            title: 'Data Encryption and Blockchain Security',
            weeks: 'Week 7-8',
            description: [
                'Encryption techniques and blockchain integration',
                'Practical: Implementing blockchain for secure data storage'
            ]
        },
        {
            id: 5,
            ...
            weeks: 'Week 9-10',
            description: [
                'Developing AI-powered security applications',
                'Project: AI-Powered Malware Detection System'
            ]
        },
        {
            id: 6,
