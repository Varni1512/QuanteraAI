...
const Advance17 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Basics of Full Stack Development',
            weeks: 'Week 1-2',
            description: [
                'HTML, CSS, JavaScript',
                'Setting up frontend frameworks (React/Angular)',
                'Practical: Developing a responsive UI'
            ]
        },
        {
            id: 2,
            ...
            description: [
                ...
                'Practical: Implementing CRUD operations'
            ]
        },
        {
            id: 3,
            ...
            weeks: 'Week 5-6',
            description: [
                'Introduction to AI and ML models',
                'Integrating Python ML models with web apps',
                'Practical: Deploying sentiment analysis model'
            ]
        },
        {
            id: 4,
            ...
            weeks: 'Week 7-8',
            description: [
                'Implementing chatbots and AI-powered features',
                'Practical: Developing a recommendation engine'
            ]
        },
        {
            id: 5,
            ...
            weeks: 'Week 9-10',
            description: [
                'Deploying full stack apps on cloud platforms',
                'Implementing DevOps and CI/CD pipelines',
                'Practical: Deploying a full stack app on AWS'
            ]
        },
        {
            id: 6,
