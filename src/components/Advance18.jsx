...
const Advance18 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to Spanish Language & Basic Communication',
            weeks: 'Week 1-2',
            description: [
                'Introduction to Spanish alphabets, pronunciation, and common phrases',
        ...
        },
        {
            ...
            description: [
                ...
                'Verb conjugation – present tense (regular and irregular verbs)',
        ...
        },
        {
            ...
            description: [
                ...
                'Cultural insights – Spanish-speaking countries and traditions',
                'Making plans and inviting someone',
                'Writing short paragraphs and emails',
                'Role-playing – travel and directions',
                'Vocabulary expansion – transportation and accommodation',
                'Project – creating a travel itinerary in Spanish',
                'Revision and review',
