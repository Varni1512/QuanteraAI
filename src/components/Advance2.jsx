    ...
    const courseModules = [
        {
            ...
            weeks: 'Week 1-2',
            description: [
                'Elements of a strong professional presence.',
                'Self-assessment: Current professional image.',
                'Exercises: Elevator pitch and personal branding statement.'
            ]
        },
        {
            id: 2,
            title: 'Workplace Etiquette and Corporate Communication',
            weeks: 'Week 3-4',
            description: [
                'Professional email and meeting etiquette.',
                'Managing difficult conversations.',
                'Group activities: Practice workplace scenarios.'
            ]
        },
        {
            id: 3,
            title: 'LinkedIn Branding and Networking',
            weeks: 'Week 5-6',
            description: [
                'Optimizing LinkedIn profiles.',
                'Strategies for professional networking.',
                'Exercise: Draft a LinkedIn content plan.'
            ]
        },
        {
            id: 4,
            title: 'Personal Branding Strategy Development',
            weeks: 'Week 7-8',
            description: [
                'Identifying core values and unique strengths.',
                'Creating a personal branding roadmap.',
                'Individual project: Develop a personal branding strategy.'
            ]
        },
        {
            id: 5,
            title: 'Presenting Your Brand',
            weeks: 'Week 9-10',
            description: [
                'Crafting a professional introduction.',
                'Mock presentations and feedback.',
                'Refining the branding strategy based on feedback.'
            ]
        },
        {
            id: 6,
            title: 'Project Submission and Reflection',
            weeks: 'Week 11-12',
            description: [
                'Present branding strategy.',
