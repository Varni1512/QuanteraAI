...
const Advance20 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to German Language & Basic Communication',
            weeks: 'Week 1-2',
            description: [
                'Introduction to German alphabets, pronunciation, and basic greetings',
        ...
        },
        {
            ...
            description: [
                ...
                'Verb conjugation – irregular verbs (Sein, Haben, Werden)',
        ...
        },
        {
            ...
            description: [
                ...
                'Cultural insights – German-speaking countries and traditions',
                ...
                'Project – creating a travel itinerary in German',
                'Revision and review',
