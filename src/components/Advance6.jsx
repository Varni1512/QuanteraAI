...
const Advance6 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to Sustainability and ESG',
            weeks: 'Week 1',
            description: [
                'Basics of Environmental, Social, and Governance (ESG)',
                'Sustainable Business Practices',
                'Impact of Tech on Sustainability'
            ]
        },
        {
            id: 2,
            title: 'Green Technologies and Digital Solutions',
            weeks: 'Week 2',
            description: [
        ...
        {
            id: 8,
            title: 'ESG Case Studies and Future Trends',
            weeks: 'Week 8',
            description: [
