    ...
    const courseModules = [
        {
            ...
            weeks: 'Week 1',
            description: [
                'Basics of Supply Chain and Logistics',
        ...
        {
            id: 2,
            title: 'IoT Applications in Supply Chain',
            weeks: 'Week 2',
            description: [
        ...
        {
            id: 4,
            title: 'AI in Demand Forecasting',
            weeks: 'Week 4',
            description: [
        ...
        {
            id: 5,
            title: 'Smart Warehousing and Inventory Control',
            weeks: 'Week 5',
            description: [
                'Automated Warehousing Systems',
                'Inventory Optimization Techniques',
                'RFID and QR Code Implementation'
            ]
        },
        {
            id: 6,
        ...
        {
            id: 8,
            title: 'Real-world Case Studies in Supply Chain',
            weeks: 'Week 8',
            description: [
                'Analysis of Leading Supply Chain Models',
                'Implementation Challenges',
                'Future Trends in Tech-Driven Logistics'
            ]
        }
    ];
