...
const Advance9 = () => {
    ...
    const courseModules = [
        {
            id: 1,
            title: 'Introduction to FinTech Ecosystem',
            weeks: 'Week 1',
            description: [
        ...
        {
            id: 3,
            title: 'AI in Financial Decision Making',
            weeks: 'Week 3',
            description: [
        ...
        {
            id: 5,
            title: 'FinTech Regulations and Compliance',
            weeks: 'Week 5',
            description: [
        ...
        {
            id: 6,
            title: 'Smart Contracts and Digital Lending',
            weeks: 'Week 6',
            description: [
                'Understanding Smart Contracts',
                'Applications in Lending and Insurance',
        ...
        {
            id: 8,
            title: 'FinTech Case Studies and Future Trends',
            weeks: 'Week 8',
            description: [
                'Analysis of FinTech Startups',
                'Lessons from Leading Digital Banks',
