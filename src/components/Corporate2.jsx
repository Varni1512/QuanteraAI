            ...
            <div className="container mx-auto px-4 pt-32 pb-8 max-w-7xl">
                ...
                <div className="w-full mb-10 flex justify-center">
                    <img
                        ...
                        className="rounded-[15px] shadow-md w-full max-w-[634px] h-auto object-cover"
                    />
                </div>
                ...
                <div className="mb-12 px-2 md:px-0">
                    ...
                    >
                        {courses.map(({ title, path }, index) => (
                            <div
                                key={index}
                                className="rounded-lg p-6 md:p-8 shadow-sm transition-shadow w-full cursor-pointer bg-[#ECF7FF]"
