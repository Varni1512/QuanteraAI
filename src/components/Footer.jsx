        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a href="#" style={{ color: '#BEBEBE' }} className="hover:scale-105 transition-transform duration-200">
          ...
          <div>
            ...
            <ul style={{ color: '#BEBEBE' }} className="space-y-2 text-[18px] font-robotoslab text-sm gap-15px">
              <li><a href="#" className="hover:text-white">Artificial Intelligence (AI)-Based Services</a></li>
              <li><a href="#" className="hover:text-white">Open Data Centers in Educational Institutions</a></li>
              <li><a href="#" className="hover:text-white">Emerging Technology Training Programs</a></li>
              <li><a href="#" className="hover:text-white">Spanish Language Program for Students</a></li>
              <li><a href="#" className="hover:text-white">Internship Programs</a></li>
              <li><a href="#" className="hover:text-white">Career Counseling Services</a></li>
            </ul>
          </div>
