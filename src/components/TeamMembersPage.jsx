...
const teamMembers = [
  ...
  },
  {
    ...
    name: "Mr. Ankit Shashtri",
    team: "CEO, SVELTOSE TECHNOLOGIES PVT.LTD.",
    linkedin: "#",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    src: "/member5.png",
    alt: "Team member portrait 2",
    name: "Mr. Ayush Shrivastava",
    team: "FOUNDER AT DEVELOP INDIA ONLINE(DIO)",
    linkedin: "#",
  },
  {
    id: 6,
    src: "/member6.png",
    alt: "Team member portrait 3",
    name: "Mr. Anshul Shrivastava",
    team: "SYSTEM SOFTWARE ENGINEER",
    linkedin: "#",
  },
  // add more members...
];
        ...
        {teamMembers.map((member) => (
          ...
          >
            <img
              src={member.src}
              alt={member.alt}
              className="w-full h-67 object-cover object-center transition-transform duration-300 scale-100 group-hover:scale-105"
            />
